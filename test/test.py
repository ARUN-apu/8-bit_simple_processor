...
async def test_project(dut):
    ...
    # Check PC reset to 0
    pc_after_reset = dut.uio_out.value
    ...
    pc_after_restart = dut.uio_out.value
    ...
    start_pc = dut.uio_out.value
    await ClockCycles(dut.clk, 20)
    end_pc = dut.uio_out.value
...
async def test_io_functionality(dut):
    ...
    initial_pc = dut.uio_out.value
    
    await ClockCycles(dut.clk, 5)
    
    final_alu = dut.uo_out.value
    final_pc = dut.uio_out.value
    ...
    dut._log.info("I/O functionality test passed")# SPDX-FileCopyrightText: © 2024 Tiny Tapeout
# SPDX-License-Identifier: Apache-2.0
